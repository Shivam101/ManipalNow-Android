...
public class ImageAdapter extends ArrayAdapter<Level> {
	
	 static Context context;
	    static int layoutResourceId;   
	     Level data[] = null;
	   
	 public ImageAdapter(Context context, int layoutResourceId, Level[] data) {
	        ...
	        if(row == null)
	        {
	         ...
	         //   holder.txtTitle3 = (TextView)row.findViewById(R.id.txtTitle3);
	          ...
	          //   holder.imgIcon2=(ImageView)row.findViewById(R.id.imgIcon2);
	    		...
	    		Typeface robotoLightItalic = Typeface.createFromAsset(getContext().getAssets(), "Roboto-LightItalic.ttf");
	    		Typeface robotoRegular = Typeface.createFromAsset(getContext().getAssets(), "Roboto-Regular.ttf");
	    		holder.txtTitle.setTypeface(robotoLight);
	            holder.txtTitle2.setTypeface(robotoLightItalic);
	            row.setTag(holder);
	        }
	        else
	        {
